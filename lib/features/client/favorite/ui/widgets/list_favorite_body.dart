...
class ListFavoriteBody  extends StatefulWidget {
  const ListFavoriteBody({super.key});

  @override
  State<ListFavoriteBody> createState() => _ListFavoriteBodyState();
}

class _ListFavoriteBodyState extends State<ListFavoriteBody> {
  // void didPopNext() {
