...
class CardWarchaItem extends StatefulWidget {
  const CardWarchaItem({super.key,});
  @override
  State<CardWarchaItem> createState() => _CardWarchaItemState();
}

class _CardWarchaItemState extends State<CardWarchaItem> {
  @override
  void initState() {
    super.initState();
  ...
  //   routeObserver.subscribe(this as RouteAware, ModalRoute.of(context)!);
  // }
  //
  // @override
  // void dispose() {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocConsumer<WorkshopsCubit,WorkshopsState>(
        listenWhen: (previous, current) => current is WorkshopsRefresh && current is GetWorkshopsSuccess ,
        listener: (context, state) {
     if(state is GetWorkshopsSuccess){
       BlocProvider.of<WorkshopsCubit>(context).fetchWorkshops();
     }
        },
        builder: (context, state) {
          ...
          else if(state is GetWorkshopsSuccess){
         ...
         }else if(state is GetWorkshopsError){
